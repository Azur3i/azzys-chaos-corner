...
uasort($statblocks, fn($a, $b) => strcmp($a["name"], $b["name"]));

uasort($statblocks, fn($a, $b) => $a["cr"] <=> $b["cr"]);
    ...
    <div class="row justify-content-center">
        <div class="main-content col-md-12 col-lg-9 mx-auto py-0">
            <div class="content-list row" style="padding: 0;" id="spell-view">
                        ...
                        <ul class="list-group" style="padding: 0;">
                            ...
                            foreach ($statblocks as $x => $y): ?>
                                <a 
                                    ...
                                    data-name="<?= $y["name"] ?>"
                                    data-creaturetype="<?= $y["creatureType"] ?>"
                                    data-cr="<?= $y["cr"] ?>"
                                    data-source="<?= $y["source"] ?>"
                                >
                                    <span class="md" style="text-align: left;"><?= $y["name"] ?></span>
                                    <span class="sm" style="opacity: 0.7;">CR <?= $y["cr"] . " " . ucfirst($y["creatureType"]) ?></span>
                                </a>
                                <?php $i++;
                            endforeach; ?>
                        </ul>
                ...
                <!-- spell display -->
                <div id="statblockbox" class="col-md-12 col-lg-8" style="padding-right: 0;">
...
<div id="title" data-id="Bestiary - "></div>

<script src="/scripts/js/bestiary.js"></script>
