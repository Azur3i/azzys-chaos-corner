...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="main-content col-md-12 col-lg-9 mx-auto">
            <div class="content-list row" style="padding: 0;">
                <div class="content-list col-4" style="padding: 1.25rem; margin: 0;" id="spell-list">
                    <div class="scroll">
                        <ul class="list-group">
                            <?php $i = 0;
                ...
                <div id="spellbox" class="col-8" style="padding-right: 0;">
